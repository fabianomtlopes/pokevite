...
<style scoped>
    ...
    background: radial-gradient(circle, rgba(97,63,251,0.6) 0%, rgba(70,252,244,0.2) 100%);
    cursor: pointer;
    }
    .cardListPokemon:hover {
    background: rgb(72,63,251);
    background: radial-gradient(circle, rgba(97,63,251,0.6) 0%, rgba(70,252,244,0.4) 100%);
    }
